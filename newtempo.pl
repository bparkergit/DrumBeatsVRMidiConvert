		...
		@line1 = split('\, ', $_);
		 ...
		 if($line1[5] =~ 960){
			...
			print "$line1[0], $line1[1], $line1[2], $line1[3], $line1[4], $line1[5]";
                        ...
                        @line2 = split('\, ', $_);
			if($newtempo == 1 && $div == 120 && $line2[3] != 1234567 && $line2[3] < 1000000){
			  $tempo = 400000;
			  print "$line2[0], $line2[1], $line2[2], $tempo\n";
			}			
                        elsif($newtempo == 1 && $div == 192 && $line2[3] != 1234567 && $line2[3] < 1000000){
			  $tempo = 500000;
			  print "$line2[0], $line2[1], $line2[2], $tempo\n";
			}			
                        elsif($newtempo == 1 && $div == 480 && $line2[3] != 1234567 && $line2[3] < 1000000){
			  $tempo = 600000;
			  print "$line2[0], $line2[1], $line2[2], $tempo\n";
			}
